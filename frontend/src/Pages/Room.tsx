...
const Room = () => {
  ...
  return (
    ...
    <div className='flex-1 flex flex-col md:flex-row gap-5'>
        ...
        <div className='flex flex-col items-center p-4 bg-gray-800 rounded-lg shadow-lg md:w-1/4'>
            ...
            <button
                ...
                className='px-6 py-2 bg-green-600 hover:bg-green-700 rounded-lg shadow-md text-white'
            >
                Send My Stream
            </button>
        </div>
